...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private Handler _postDelayedHandler = new Handler();
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		if(!isInEditMode()) {
			final int resourceId = a.getResourceId(R.styleable.PagerSlidingTabStrip_pstsResourceId, -1);
			if (resourceId != -1)
				_postDelayedHandler.postDelayed(new Runnable() {
					@Override
					public void run() {
						Boolean found = PagerSlidingTabStrip.this.setResourceId(resourceId);
						if(!found)
							_postDelayedHandler.postDelayed(this, 1);
					}
				}, 1);
		}
