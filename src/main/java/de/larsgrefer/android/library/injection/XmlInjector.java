...
import de.larsgrefer.android.library.injection.annotation.Attribute;
import de.larsgrefer.android.library.injection.annotation.Resource;
...
public abstract class XmlInjector<T> {
	...
	public void injectAttributes() {
		...
		List<Field> attrFields = Reflection.getDeclaredFieldsWithAnnotationPresent(getObjectClass(), Attribute.class);
	...
	public void injectResources() {
		...
		List<Field> resourceFields = Reflection.getDeclaredFieldsWithAnnotationPresent(getObjectClass(), Resource.class);
