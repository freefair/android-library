...
import de.fhconfig.android.library.TruePredicate;
...
public class Reflection {
	...
	public static <T> List<Field> getAllFields(Class<T> clazz){
		return getAllFields(clazz, Optional.<Class<? super T>>absent(),new TruePredicate<Field>());
	}
	...
	public static <T> List<Field> getDeclaredFields(Class<T> clazz, Class<? super T> upToExcluding){
		return getAllFields(clazz, Optional.<Class<? super T>>fromNullable(upToExcluding), new TruePredicate<Field>());
	}

	public static <T> List<Field> getAllFields(Class<T> clazz, Optional<Class<? super T>> upToExcluding){
		return getAllFields(clazz, upToExcluding, new TruePredicate<Field>());
	}

	public static <T> List<Field> getAllFields(Class<T> clazz, Class<? super T> upToExcluding, Predicate<Field> filter){
		return getAllFields(clazz, Optional.<Class<? super T>>fromNullable(upToExcluding), filter);
	}

	public static <T> List<Field> getAllFields(Class<T> clazz, Optional<Class<? super T>> upToExcluding, Predicate<Field> filter){
