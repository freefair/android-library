 ...
 * It will return a simple adapter, the same parameters to de.fhconfig.android.binding.collections.Utility.getSimpleAdapter:
 *
 * @author andy
 * @usage params
 ...
 * @item @optional spinnerTemplate de.fhconfig.android.binding.viewAttributes.templates.Layout
