...
public class BindingActivity extends InjectionAppCompatActivity implements android.support.v7.widget.Toolbar.OnMenuItemClickListener, ViewTreeObserver.OnGlobalLayoutListener {
	...
	private void inflateAndBind() {
		try {
			...
			treeObserver = binding.getRoot().getViewTreeObserver();
